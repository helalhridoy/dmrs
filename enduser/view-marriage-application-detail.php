...
<tr>
<th>Resident at:</th>  
<td><?php  echo $row->HusbandAdd;?>,<?php  echo $row->HusbandZipcode;?>,<?php  echo $row->HusbandCity;?></td>
</tr>
...
<table class="table table-hover table-bordered table-purple mg-b-0" style="margin-top:1%" border="1">
             ...
             <tr>
               ...
               Photo of Bride</td>
                ...
                <tr>
               <th>Resident at:</th>
               <td> <?php  echo $row->WifeAdd;?>,<?php  echo $row->WifeZipcode;?>,<?php  echo $row->WifeCity;?></td>
             </tr>
     <tr>
               <th>Date of Birth:</th>
...
<p style="margin-top:1%; font-size:16px;">Having been Solemnized at XYZ(city) on <?php  echo $row->DateofMarriage;?> according to the custom praticed by parties duly witness by:</p>
